...
public class AllCases extends CasesProcessor implements IWPageEventListener {

	public static final String pageType = "allCases";
...
//		Object caseTypePK = iwc.isParameterSet(PARAMETER_CASE_TYPE_PK) ? iwc.getParameter(PARAMETER_CASE_TYPE_PK) : null;
	...
	public String getCasesProcessorType() {
		return "ALLCases";//CasesRetrievalManager.CASE_LIST_TYPE_ALL;
	}
}